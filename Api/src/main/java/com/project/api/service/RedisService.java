...
public interface RedisService {
	 ...
	 * @param num
	 */
	double increaseNumByKeyAndInnerKey(final String key, final String value, final double num);
	...
	long hashSetIncr(final String key, final String innerKey, final long innerVal);
