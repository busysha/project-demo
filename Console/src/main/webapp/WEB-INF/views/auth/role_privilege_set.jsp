			...
			<div class="row-fluid">
				...
				<section class="panel"> 
		                <div class="panel-body">
		                    <form:form id="userForm" class=" form-horizontal" action="${ctx}/role/privilegeset" method="post" modelAttribute="roleBean" onsubmit="return toVaild()">
		                        <div class="form-group">
		                            <label class="col-sm-2 col-lg-2 control-label">用户名: </label>
		                            <div class="col-sm-4 col-lg-4">
		                           	 <form:input type="hidden" id="roleId"  class="form-control"   path="roleId" />
